...
def __rshift__(*args):
  """__rshift__(std::istream & stream, yarp::os::ConstString & str) -> std::istream &"""
  return _yarp.__rshift__(*args)

def __lshift__(*args):
  """__lshift__(std::ostream & stream, yarp::os::ConstString const & str) -> std::ostream &"""
  return _yarp.__lshift__(*args)

def __add__(*args):
  """
    __add__(yarp::os::ConstString const & lhs, yarp::os::ConstString const & rhs) -> yarp::os::ConstString
    __add__(yarp::os::ConstString const & lhs, char const * rhs) -> yarp::os::ConstString
    __add__(char const * lhs, yarp::os::ConstString const & rhs) -> yarp::os::ConstString
    __add__(yarp::os::ConstString const & lhs, char rhs) -> yarp::os::ConstString
    __add__(char lhs, yarp::os::ConstString const & rhs) -> yarp::os::ConstString
    """
  return _yarp.__add__(*args)

def isEqual(*args):
  """
    isEqual(yarp::os::ConstString const & lhs, yarp::os::ConstString const & rhs) -> bool
    isEqual(char const * lhs, yarp::os::ConstString const & rhs) -> bool
    isEqual(yarp::os::ConstString const & lhs, char const * rhs) -> bool
    """
  return _yarp.isEqual(*args)

def notEqual(*args):
  """
    notEqual(yarp::os::ConstString const & lhs, yarp::os::ConstString const & rhs) -> bool
    notEqual(char const * lhs, yarp::os::ConstString const & rhs) -> bool
    notEqual(yarp::os::ConstString const & lhs, char const * rhs) -> bool
    """
  return _yarp.notEqual(*args)

def __lt__(*args):
  """
    __lt__(yarp::os::ConstString const & lhs, yarp::os::ConstString const & rhs) -> bool
    __lt__(char const * lhs, yarp::os::ConstString const & rhs) -> bool
    __lt__(yarp::os::ConstString const & lhs, char const * rhs) -> bool
    """
  return _yarp.__lt__(*args)

def __le__(*args):
  """
    __le__(yarp::os::ConstString const & lhs, yarp::os::ConstString const & rhs) -> bool
    __le__(char const * lhs, yarp::os::ConstString const & rhs) -> bool
    __le__(yarp::os::ConstString const & lhs, char const * rhs) -> bool
    """
  return _yarp.__le__(*args)

def __gt__(*args):
  """
    __gt__(yarp::os::ConstString const & lhs, yarp::os::ConstString const & rhs) -> bool
    __gt__(char const * lhs, yarp::os::ConstString const & rhs) -> bool
    __gt__(yarp::os::ConstString const & lhs, char const * rhs) -> bool
    """
  return _yarp.__gt__(*args)

def __ge__(*args):
  """
    __ge__(yarp::os::ConstString const & lhs, yarp::os::ConstString const & rhs) -> bool
    __ge__(char const * lhs, yarp::os::ConstString const & rhs) -> bool
    __ge__(yarp::os::ConstString const & lhs, char const * rhs) -> bool
    """
  return _yarp.__ge__(*args)

def swap(*args):
  """swap(yarp::os::ConstString & x, yarp::os::ConstString & y)"""
  return _yarp.swap(*args)

def getline(*args):
  """
    getline(std::istream & _is, yarp::os::ConstString & str, char delim) -> std::istream
    getline(std::istream & _is, yarp::os::ConstString & str) -> std::istream &
    """
  return _yarp.getline(*args)
...
class Contact(_object):
    ...
    def addPort(self, *args):
        """addPort(Contact self, int portnumber) -> Contact"""
        return _yarp.Contact_addPort(self, *args)

    def bySocket(*args):
        """bySocket(yarp::os::ConstString const & carrier, yarp::os::ConstString const & hostname, int portNumber) -> Contact"""
    ...
    def addSocket(self, *args):
        """addSocket(Contact self, yarp::os::ConstString const & carrier, yarp::os::ConstString const & hostname, int portNumber) -> Contact"""
    ...
    def setHost(self, *args):
        """setHost(Contact self, yarp::os::ConstString const & host)"""
        return _yarp.Contact_setHost(self, *args)

    def setPort(self, *args):
        """setPort(Contact self, int port)"""
        return _yarp.Contact_setPort(self, *args)
...
def Contact_bySocket(*args):
  """Contact_bySocket(yarp::os::ConstString const & carrier, yarp::os::ConstString const & hostname, int portNumber) -> Contact"""
  return _yarp.Contact_bySocket(*args)
...
class NetworkBase(_object):
    ...
    def setNameServerContact(*args):
        """setNameServerContact(Contact nameServerContact) -> bool"""
        return _yarp.NetworkBase_setNameServerContact(*args)

    if _newclass:setNameServerContact = staticmethod(setNameServerContact)
    ...
    def setConnectionQos(*args):
        """
        setConnectionQos(yarp::os::ConstString const & src, yarp::os::ConstString const & dest, QosStyle srcStyle, 
            QosStyle destStyle, bool quiet=True) -> bool
        setConnectionQos(yarp::os::ConstString const & src, yarp::os::ConstString const & dest, QosStyle srcStyle, 
            QosStyle destStyle) -> bool
        setConnectionQos(yarp::os::ConstString const & src, yarp::os::ConstString const & dest, QosStyle style, 
            bool quiet=True) -> bool
    ...
    if _newclass:setConnectionQos = staticmethod(setConnectionQos)
    __swig_getmethods__["setConnectionQos"] = lambda x: setConnectionQos
    def getConnectionQos(*args):
        """
        getConnectionQos(yarp::os::ConstString const & src, yarp::os::ConstString const & dest, QosStyle srcStyle, 
            QosStyle destStyle, bool quiet=True) -> bool
        getConnectionQos(yarp::os::ConstString const & src, yarp::os::ConstString const & dest, QosStyle srcStyle, 
            QosStyle destStyle) -> bool
        """
        return _yarp.NetworkBase_getConnectionQos(*args)

    if _newclass:getConnectionQos = staticmethod(getConnectionQos)
...
def NetworkBase_setNameServerContact(*args):
...
def NetworkBase_getConnectionQos(*args):
  """
    getConnectionQos(yarp::os::ConstString const & src, yarp::os::ConstString const & dest, QosStyle srcStyle, 
        QosStyle destStyle, bool quiet=True) -> bool
    NetworkBase_getConnectionQos(yarp::os::ConstString const & src, yarp::os::ConstString const & dest, QosStyle srcStyle, 
        QosStyle destStyle) -> bool
    """
  return _yarp.NetworkBase_getConnectionQos(*args)
...
class Property(Searchable,Portable):
    ...
    def fromConfigDir(self, *args):
        """
        fromConfigDir(Property self, yarp::os::ConstString const & dirname, yarp::os::ConstString const & section=yarp::os::ConstString(), 
            bool wipe=True) -> bool
        fromConfigDir(Property self, yarp::os::ConstString const & dirname, yarp::os::ConstString const & section=yarp::os::ConstString()) -> bool
...
class Things(_object):
    ...
    def setPortReader(self, *args):
        """setPortReader(Things self, PortReader reader)"""
        return _yarp.Things_setPortReader(self, *args)
...
class QosStyle(_object):
    ...
    def setPacketPriorityByDscp(self, *args):
        """setPacketPriorityByDscp(QosStyle self, yarp::os::QosStyle::PacketPriorityDSCP dscp)"""
        return _yarp.QosStyle_setPacketPriorityByDscp(self, *args)

    def setPacketPriorityByLevel(self, *args):
        """setPacketPriorityByLevel(QosStyle self, yarp::os::QosStyle::PacketPriorityLevel level)"""
        return _yarp.QosStyle_setPacketPriorityByLevel(self, *args)

    def setPacketPrioritybyTOS(self, *args):
        """setPacketPrioritybyTOS(QosStyle self, int tos)"""
        return _yarp.QosStyle_setPacketPrioritybyTOS(self, *args)

    def setPacketPriority(self, *args):
        """setPacketPriority(QosStyle self, yarp::os::ConstString const & priority) -> bool"""
        return _yarp.QosStyle_setPacketPriority(self, *args)

    def setThreadPriority(self, *args):
        """setThreadPriority(QosStyle self, int priority)"""
        return _yarp.QosStyle_setThreadPriority(self, *args)

    def setThreadPolicy(self, *args):
        """setThreadPolicy(QosStyle self, int policy)"""
        return _yarp.QosStyle_setThreadPolicy(self, *args)
    ...
    def getDSCPByVocab(*args):
        """getDSCPByVocab(int vocab) -> yarp::os::QosStyle::PacketPriorityDSCP"""
        return _yarp.QosStyle_getDSCPByVocab(*args)

    if _newclass:getDSCPByVocab = staticmethod(getDSCPByVocab)
    __swig_getmethods__["getDSCPByVocab"] = lambda x: getDSCPByVocab
    def getLevelByVocab(*args):
        """getLevelByVocab(int vocab) -> yarp::os::QosStyle::PacketPriorityLevel"""
        return _yarp.QosStyle_getLevelByVocab(*args)

    if _newclass:getLevelByVocab = staticmethod(getLevelByVocab)
...
YARP_FEATURE_NUMEBR_OF = _yarp.YARP_FEATURE_NUMEBR_OF
...
class CalibrationParameters(_object):
    ...
    if _newclass:type = _swig_property(_yarp.CalibrationParameters_type_get, _yarp.CalibrationParameters_type_set)
    ...
    if _newclass:param1 = _swig_property(_yarp.CalibrationParameters_param1_get, _yarp.CalibrationParameters_param1_set)
    ...
    if _newclass:param2 = _swig_property(_yarp.CalibrationParameters_param2_get, _yarp.CalibrationParameters_param2_set)
    ...
    if _newclass:param3 = _swig_property(_yarp.CalibrationParameters_param3_get, _yarp.CalibrationParameters_param3_set)
    ...
    if _newclass:param4 = _swig_property(_yarp.CalibrationParameters_param4_get, _yarp.CalibrationParameters_param4_set)
    ...
    if _newclass:param5 = _swig_property(_yarp.CalibrationParameters_param5_get, _yarp.CalibrationParameters_param5_set)
    ...
    if _newclass:paramZero = _swig_property(_yarp.CalibrationParameters_paramZero_get, _yarp.CalibrationParameters_paramZero_set)
    def __init__(self): 
...
class IAmplifierControl(_object):
    ...
    def setPeakCurrent(self, *args):
        """setPeakCurrent(IAmplifierControl self, int m, double const val) -> bool"""
        return _yarp.IAmplifierControl_setPeakCurrent(self, *args)
    ...
    def setPWMLimit(self, *args):
        """setPWMLimit(IAmplifierControl self, int j, double const val) -> bool"""
        return _yarp.IAmplifierControl_setPWMLimit(self, *args)
...
class IAmplifierControlRaw(_object):
    ...
    def getMaxCurrentRaw(self, *args):
        """getMaxCurrentRaw(IAmplifierControlRaw self, int j, double * v) -> bool"""
        return _yarp.IAmplifierControlRaw_getMaxCurrentRaw(self, *args)

    def getNominalCurrentRaw(self, *args):
        """getNominalCurrentRaw(IAmplifierControlRaw self, int m, double * val) -> bool"""
        return _yarp.IAmplifierControlRaw_getNominalCurrentRaw(self, *args)

    def getPeakCurrentRaw(self, *args):
        """getPeakCurrentRaw(IAmplifierControlRaw self, int m, double * val) -> bool"""
        return _yarp.IAmplifierControlRaw_getPeakCurrentRaw(self, *args)

    def setPeakCurrentRaw(self, *args):
        """setPeakCurrentRaw(IAmplifierControlRaw self, int m, double const val) -> bool"""
        return _yarp.IAmplifierControlRaw_setPeakCurrentRaw(self, *args)

    def getPWMRaw(self, *args):
        """getPWMRaw(IAmplifierControlRaw self, int j, double * val) -> bool"""
        return _yarp.IAmplifierControlRaw_getPWMRaw(self, *args)

    def getPWMLimitRaw(self, *args):
        """getPWMLimitRaw(IAmplifierControlRaw self, int j, double * val) -> bool"""
        return _yarp.IAmplifierControlRaw_getPWMLimitRaw(self, *args)

    def setPWMLimitRaw(self, *args):
        """setPWMLimitRaw(IAmplifierControlRaw self, int j, double const val) -> bool"""
        return _yarp.IAmplifierControlRaw_setPWMLimitRaw(self, *args)

    def getPowerSupplyVoltageRaw(self, *args):
        """getPowerSupplyVoltageRaw(IAmplifierControlRaw self, int j, double * val) -> bool"""
        return _yarp.IAmplifierControlRaw_getPowerSupplyVoltageRaw(self, *args)
...
class IControlCalibration2Raw(_object):
    ...
    def setCalibrationParametersRaw(self, *args):
        """setCalibrationParametersRaw(IControlCalibration2Raw self, int axis, CalibrationParameters params) -> bool"""
        return _yarp.IControlCalibration2Raw_setCalibrationParametersRaw(self, *args)
...
class IControlCalibration2(_object):
    ...
    def setCalibrationParameters(self, *args):
        """setCalibrationParameters(IControlCalibration2 self, int axis, CalibrationParameters params) -> bool"""
        return _yarp.IControlCalibration2_setCalibrationParameters(self, *args)
...
class IAxisInfoRaw(_object):
    ...
    __del__ = lambda self : None;
    def getAxisNameRaw(self, *args):
        """getAxisNameRaw(IAxisInfoRaw self, int axis, yarp::os::ConstString & name) -> bool"""
        return _yarp.IAxisInfoRaw_getAxisNameRaw(self, *args)

    def getJointTypeRaw(self, *args):
        """getJointTypeRaw(IAxisInfoRaw self, int axis, yarp::dev::JointTypeEnum & type) -> bool"""
        return _yarp.IAxisInfoRaw_getJointTypeRaw(self, *args)
...
class IGazeControl(_object):
    ...
    def setStabilizationMode(self, *args):
        """setStabilizationMode(IGazeControl self, bool const f) -> bool"""
        return _yarp.IGazeControl_setStabilizationMode(self, *args)

    def getStabilizationMode(self, *args):
        """getStabilizationMode(IGazeControl self, bool * f) -> bool"""
        return _yarp.IGazeControl_getStabilizationMode(self, *args)
    ...
    def getSaccadesMode(self, *args):
        """getSaccadesMode(IGazeControl self, bool * f) -> bool"""
        return _yarp.IGazeControl_getSaccadesMode(self, *args)
    ...
    def setSaccadesMode(self, *args):
        """setSaccadesMode(IGazeControl self, bool const f) -> bool"""
        return _yarp.IGazeControl_setSaccadesMode(self, *args)
...
class IRemoteCalibrator(_object):
    ...
    __del__ = lambda self : None;
    def setCalibratorDevice(self, *args):
        """setCalibratorDevice(IRemoteCalibrator self, IRemoteCalibrator dev) -> bool"""
        return _yarp.IRemoteCalibrator_setCalibratorDevice(self, *args)
    ...
    def isCalibratorDevicePresent(self, *args):
        """isCalibratorDevicePresent(IRemoteCalibrator self, bool * isCalib) -> bool"""
        return _yarp.IRemoteCalibrator_isCalibratorDevicePresent(self, *args)
    ...
    def calibrateSingleJoint(self, *args):
        """calibrateSingleJoint(IRemoteCalibrator self, int j) -> bool"""
        return _yarp.IRemoteCalibrator_calibrateSingleJoint(self, *args)
...
class MotorTorqueParameters(_object):
    ...
    if _newclass:bemf = _swig_property(_yarp.MotorTorqueParameters_bemf_get, _yarp.MotorTorqueParameters_bemf_set)
    ...
    if _newclass:bemf_scale = _swig_property(_yarp.MotorTorqueParameters_bemf_scale_get, _yarp.MotorTorqueParameters_bemf_scale_set)
    ...
    if _newclass:ktau = _swig_property(_yarp.MotorTorqueParameters_ktau_get, _yarp.MotorTorqueParameters_ktau_set)
    ...
    if _newclass:ktau_scale = _swig_property(_yarp.MotorTorqueParameters_ktau_scale_get, _yarp.MotorTorqueParameters_ktau_scale_set)
    def __init__(self): 
...
class ITorqueControl(_object):
    ...
    def setMotorTorqueParams(self, *args):
        """setMotorTorqueParams(ITorqueControl self, int j, MotorTorqueParameters params) -> bool"""
        return _yarp.ITorqueControl_setMotorTorqueParams(self, *args)
...
class ITorqueControlRaw(_object):
    ...
    def getMotorTorqueParamsRaw(self, *args):
        """getMotorTorqueParamsRaw(ITorqueControlRaw self, int j, MotorTorqueParameters params) -> bool"""
        return _yarp.ITorqueControlRaw_getMotorTorqueParamsRaw(self, *args)

    def setMotorTorqueParamsRaw(self, *args):
        """setMotorTorqueParamsRaw(ITorqueControlRaw self, int j, MotorTorqueParameters params) -> bool"""
        return _yarp.ITorqueControlRaw_setMotorTorqueParamsRaw(self, *args)
...
class IVector(_object):
    ...
    def __getslice__(self, *args):
        ...
        return _yarp.IVector___getslice__(self, *args)
    ...
    def __delslice__(self, *args):
        ...
        return _yarp.IVector___delslice__(self, *args)
    ...
    def append(self, *args):
        ...
        return _yarp.IVector_append(self, *args)
    ...
    def swap(self, *args):
        ...
        return _yarp.IVector_swap(self, *args)
    ...
    def push_back(self, *args):
        ...
        return _yarp.IVector_push_back(self, *args)
    ...
    def assign(self, *args):
        ...
        return _yarp.IVector_assign(self, *args)
    ...
    def reserve(self, *args):
        ...
        return _yarp.IVector_reserve(self, *args)
...
class ImageMono16(Image):
    ...
    def pixel(self, *args):
        """pixel(ImageMono16 self, int x, int y) -> yarp::sig::PixelMono16 &"""
        return _yarp.ImageMono16_pixel(self, *args)

    def access(self, *args):
        """access(ImageMono16 self, int x, int y) -> yarp::sig::PixelMono16 &"""
        return _yarp.ImageMono16_access(self, *args)

    def safePixel(self, *args):
        """
        safePixel(ImageMono16 self, int x, int y) -> yarp::sig::PixelMono16
        safePixel(ImageMono16 self, int x, int y) -> yarp::sig::PixelMono16 const &
        """
...
class TypedReaderImageMono16(_object):
    ...
    def useCallback(self, *args):
        ...
        return _yarp.TypedReaderImageMono16_useCallback(self, *args)
    ...
    def setReplier(self, *args):
        ...
        return _yarp.TypedReaderImageMono16_setReplier(self, *args)
    ...
    def release(self, *args):
        ...
        return _yarp.TypedReaderImageMono16_release(self, *args)

    def setTargetPeriod(self, *args):
        """setTargetPeriod(TypedReaderImageMono16 self, double period)"""
        return _yarp.TypedReaderImageMono16_setTargetPeriod(self, *args)
...
class BufferedPortImageMono16(Contactable,TypedReaderImageMono16,TypedReaderCallbackImageMono16):
    ...
    __swig_setmethods__ = {}
    for _s in [Contactable,TypedReaderImageMono16,TypedReaderCallbackImageMono16]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, BufferedPortImageMono16, name, value)
    __swig_getmethods__ = {}
    for _s in [Contactable,TypedReaderImageMono16,TypedReaderCallbackImageMono16]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    def setReplier(self, *args):
        ...
        return _yarp.BufferedPortImageMono16_setReplier(self, *args)

    def setReader(self, *args):
        """setReader(BufferedPortImageMono16 self, PortReader reader)"""
        return _yarp.BufferedPortImageMono16_setReader(self, *args)

    def setAdminReader(self, *args):
        """setAdminReader(BufferedPortImageMono16 self, PortReader reader)"""
        return _yarp.BufferedPortImageMono16_setAdminReader(self, *args)
    ...
    def setEnvelope(self, *args):
        ...
        return _yarp.BufferedPortImageMono16_setEnvelope(self, *args)

    def getEnvelope(self, *args):
        """getEnvelope(BufferedPortImageMono16 self, PortReader envelope) -> bool"""
        return _yarp.BufferedPortImageMono16_getEnvelope(self, *args)
    ...
    def getReport(self, *args):
        ...
        return _yarp.BufferedPortImageMono16_getReport(self, *args)

    def setReporter(self, *args):
        """setReporter(BufferedPortImageMono16 self, PortReport reporter)"""
        return _yarp.BufferedPortImageMono16_setReporter(self, *args)
    ...
    def release(self, *args):
        ...
        return _yarp.BufferedPortImageMono16_release(self, *args)

    def setTargetPeriod(self, *args):
        """setTargetPeriod(BufferedPortImageMono16 self, double period)"""
        return _yarp.BufferedPortImageMono16_setTargetPeriod(self, *args)
    ...
    def promiseType(self, *args):
        ...
        return _yarp.BufferedPortImageMono16_promiseType(self, *args)

    def setInputMode(self, *args):
        """setInputMode(BufferedPortImageMono16 self, bool expectInput)"""
        return _yarp.BufferedPortImageMono16_setInputMode(self, *args)

    def setOutputMode(self, *args):
        """setOutputMode(BufferedPortImageMono16 self, bool expectOutput)"""
        return _yarp.BufferedPortImageMono16_setOutputMode(self, *args)

    def setRpcMode(self, *args):
        """setRpcMode(BufferedPortImageMono16 self, bool expectRpc)"""
        return _yarp.BufferedPortImageMono16_setRpcMode(self, *args)

    def acquireProperties(self, *args):
        """acquireProperties(BufferedPortImageMono16 self, bool readOnly) -> Property"""
        return _yarp.BufferedPortImageMono16_acquireProperties(self, *args)

    def releaseProperties(self, *args):
        """releaseProperties(BufferedPortImageMono16 self, Property prop)"""
        return _yarp.BufferedPortImageMono16_releaseProperties(self, *args)

    def includeNodeInName(self, *args):
        """includeNodeInName(BufferedPortImageMono16 self, bool flag)"""
        return _yarp.BufferedPortImageMono16_includeNodeInName(self, *args)
